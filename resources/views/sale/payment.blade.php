                ...
                <div class="col-md-12">
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-7">
                        <form method="GET" action="{{ route('sale.payment') }}">
                          <div class="input-daterange input-group" id="datepicker">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <datalist id="itemTypeList">
                                  ...
                                  <option value="{{ $data->party_name }}" data-sale-credit="{{ $data->sale_credit }}" data-sale-cash="{{ $data->sale_cash }}">
                                ...
                                <div class="form-group mt-3" id="saleCreditField" style="display: none;">
                                  ...
                                  <input type="text" class="form-control" name="sale_credit" id="saleCredit" readonly>
                                </div>
                                <div class="form-group mt-3" id="saleCashField" style="display: none;">
                                  <label for="saleCash">Sale Cash:</label>
                                  <input type="text" class="form-control" name="sale_cash" id="saleCash" readonly>
                                </div>
  ...
  function updateValues() {
    ...
    options.forEach(option => {
      if (option.value === partyInput.value) {
        selectedCredit = option.getAttribute('data-sale-credit');
        selectedCash = option.getAttribute('data-sale-cash');
        found = true;
      }
    });
